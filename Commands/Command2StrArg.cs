...
namespace ConsoleShop.Commands
{
    ...
    /// </summary>
    public class Command2StrArg : BaseCommand
    {
        /// <summary>
        ...
        public Command2StrArg(string name, string description, IEnumerable<UserRole> roles,
            Func<string, string, IActionResult> executor) 
            : base(name, description, roles)
        {
            _executor = executor;
        }
        ...
        protected override bool ReadArgs(string args)
        {
            ...
            {
                _argsErrorMessage = "You should transmit 2 non-empty quoted strings!";
                return false;
            }
            _arg1 = argsArr[0][1..];
            _arg2 = argsArr[1][..argsArr[1].IndexOf('"')];
            return true;
        }
    }
}
